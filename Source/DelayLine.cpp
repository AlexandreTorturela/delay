...
void DelayLine::setMaximumDelayInSamples(int maxLengthInSamples)
{
	...
	int paddedLength = maxLengthInSamples + 2; // Add two samples to prevent read/write collision
...
{
	writeIndex = bufferLength - 1; // Set write index to the end of the buffer
